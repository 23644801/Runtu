...
public class CirculationOfPropertyRightsActivity extends AppCompatActivity {

    Handler refreshHandler = new Handler() {
        @Override
        public void handleMessage(Message msg) {
            Toast.makeText(CirculationOfPropertyRightsActivity.this, "刷新完毕", Toast.LENGTH_SHORT).show();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_circulation_of_property_rights_layout);
        ButterKnife.bind(this);
        View header = getLayoutInflater().inflate(R.layout.business_dynamics_header_layout, null);
        View floatView = getLayoutInflater().inflate(R.layout.circulation_of_property_rights_float_menu_layout, null);
        ...
        swipeRefreshLayout.setOnRefreshListener(new PullRefreshLayout.OnRefreshListener() {
            ...
            public void onRefresh() {
                // start refresh
                Toast.makeText(CirculationOfPropertyRightsActivity.this, "开始刷新", Toast.LENGTH_SHORT).show();
...
//        banner.setBannerTitles(Arrays.asList(titles));
    ...
    void initData() {
        ...
        int resId = R.layout.circulation_of_property_rights_list_item_layout;
        crpLv.setAdapter(new CommonAdapter<String>(CirculationOfPropertyRightsActivity.this, resId, datas) {
            @Override
        ...
        crpLv.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                startActivity(new Intent(CirculationOfPropertyRightsActivity.this, PropertyRightsDetailsActivity.class));
            }
        });
    }
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            ...
            case R.id.release_Iv:
                startActivity(new Intent(CirculationOfPropertyRightsActivity.this, PropertyRightsRealse1Activity.class));
                break;
        }
    }
